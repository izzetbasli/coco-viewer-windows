...
parser.add_argument("-i", "--images", default=os.path.join('//10.10.5.98/merge_dataset/train'),
                    type=str, metavar="PATH", help="path to images folder")
parser.add_argument("-a", "--annotations", default=os.path.join('C:/Users/noname/visio-preprocessing/visio-preprocessing-coco-merge/merged_train_fix_2.json'),
                    type=str, metavar="PATH", help="path to annotations json file")
...
class Data:
    ...
    def __init__(self, image_dir, annotations_file):
        ...
        # self.image_dir = os.path.join('C:\\', 'Users', 'noname', 'Desktop', 'universal', 'train')
...
def get_categories(instances: dict) -> dict:
    ...
    """
    # Parse categories
    colors = prepare_colors(n_objects=500, shuffle=True)
